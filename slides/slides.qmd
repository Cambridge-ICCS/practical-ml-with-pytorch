...
subtitle: "Calipso Workshop 2026"
...
* 9:00-9:40: Introduction to Neural Networks  
* 9:40-12:00: Classification using tabular data
* 12:00-13:30: Lunch
* 13:30-13:45: Introduction to Convolutional Neural Networks
* 13:45-15:45: Classification using image data
* 15:45-16:30: Discussion of ML applications in Climate Science
...
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*whWZiPnG0rXxels-.jpg){style="border-radius: 50%;" .absolute top=35% left=42.5% width=65%}
...
{{< fa brands mastodon >}} \ [\@jatkinson1000\@fosstodon.org](https://hachyderm.io/@jatkinson1000)
